...
public class Pedometer extends AndroidNonvisibleComponent
  ...
  public Pedometer(ComponentContainer container) {
    ...
    sensorManager = (SensorManager) form.$context().getSystemService(Context.SENSOR_SERVICE);
    locationManager = (LocationManager) form.$context().getSystemService(Context.LOCATION_SERVICE);
    locationManager.requestLocationUpdates(LocationManager.GPS_PROVIDER, 0, 0, this);

    // Restore preferences
    SharedPreferences settings = form.$context().getSharedPreferences(PREFS_NAME, Context.MODE_PRIVATE);
