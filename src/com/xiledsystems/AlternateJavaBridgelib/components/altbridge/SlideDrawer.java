...
public class SlideDrawer extends ViewGroup {
	...
	public SlideDrawer( Context context, AttributeSet attrs, int defStyle )
	{
		...
		//TypedArray a = context.obtainStyledAttributes( attrs, com.xiledsystems.AlternateJavaBridgelib.R.styleable.DrawerSlider, defStyle, 0 );
		...
		int handleId = context.getResources().getIdentifier("handle", "id", context.getPackageName());
		//int handleId = a.getResourceId(com.xiledsystems.AlternateJavaBridgelib.R.styleable.DrawerSlider_handle, 1);
		
		if ( handleId == 0 ) { throw new IllegalArgumentException( "The handle attribute is required and must refer "
				+ "to a valid child." ); }
		
		int contentId = context.getResources().getIdentifier("DrawerSlider_content", "styleable", context.getPackageName());
		if ( contentId == 0 ) { throw new IllegalArgumentException( "The content attribute is required and must refer "
				+ "to a valid child." ); }
