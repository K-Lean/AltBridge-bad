  ...
  */
  ...
  private IClientLoginHelper createClientLoginHelper(String accountPrompt, String service) {
    if (SdkLevel.getLevel() >= SdkLevel.LEVEL_ECLAIR) {
      ...
      return new ClientLoginHelper(form.$context(), service, accountPrompt, httpClient);
    }
    return null;
  }
  ...
  private class QueryProcessor extends AsyncTask<String, Void, String> {
    ...
    protected void onPreExecute() {
      progress = ProgressDialog.show(form.$context(), "Fusiontables", "processing query...", true);
    }
